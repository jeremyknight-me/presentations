...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="table-responsive">
        <asp:ListView ID="CompanyListView" runat="server" DataSourceID="CompanyObjectDataSource" DataKeyNames="Id">
            <LayoutTemplate>
            ...
            <ItemTemplate>
                <tr style="">
                    ...
                    <td><asp:Literal ID="NameLabel" runat="server" Text='<%# Eval("Name") %>' EnableViewState="False" /></td>
                </tr>
            </ItemTemplate>
        </asp:ListView>
    </div>
    ...
    <asp:ObjectDataSource ID="CompanyObjectDataSource" runat="server" EnablePaging="True"
        SelectMethod="ListAll" SelectCountMethod="ListAllCount"
        TypeName="ClassLibrary.Presentation.Presenters.CompanyListPresenter">
        <SelectParameters>
