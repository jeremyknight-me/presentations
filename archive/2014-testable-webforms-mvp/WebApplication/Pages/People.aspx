...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="table-responsive">
        <asp:ListView ID="PersonListView" runat="server" DataSourceID="PersonSqlDataSource" DataKeyNames="Id">
            <LayoutTemplate>
    ...
    <asp:SqlDataSource ID="PersonSqlDataSource" runat="server" 
        ConnectionString="<%$ ConnectionStrings:DataStore %>" 
        SelectCommand="SELECT * FROM [Person] WHERE IsDeleted = 'False' ORDER BY [LastName], [FirstName]" />
</asp:Content>
